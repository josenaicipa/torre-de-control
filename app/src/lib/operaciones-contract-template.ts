...
// (programa de transformación empresarial); BRAND_CONSULTING es el contrato
// «Unlocked Academy Nivel 6 Brand Consulting». Refleja el enum Prisma
// ContractTemplateKind.
export type ContractTemplateKind = "TRADITIONAL" | "BUSINESS" | "BRAND_CONSULTING";

export const CONTRACT_SUBTITLE_BUSINESS = "Unlocked Academy Empresarial";
export const CONTRACT_SUBTITLE_BRAND_CONSULTING =
  "Unlocked Academy Nivel 6 Brand Consulting";

// Normaliza un valor arbitrario (típicamente de la BD o del body de la API) a
// un ContractTemplateKind. "BUSINESS" y "BRAND_CONSULTING" se respetan tal
// cual; cualquier otro valor cae a "TRADITIONAL", de modo que contratos
// antiguos/null usan el tradicional.
export function normalizeContractTemplateKind(
  value: unknown,
): ContractTemplateKind {
  if (value === "BUSINESS") return "BUSINESS";
  if (value === "BRAND_CONSULTING") return "BRAND_CONSULTING";
  return "TRADITIONAL";
}
...
// Párrafos de la cláusula "Quinta. Honorarios" del contrato BRAND CONSULTING.
// Interpola monto total, abono inicial, saldo y calendario de pagos igual que
// los demás, pero con el copy, la numeración (5.2–5.8) y el nombre del programa
// «Unlocked Academy Nivel 6 Brand Consulting» del PDF oficial, incluyendo el
// derecho de desistimiento (5.8).
function buildBrandConsultingPaymentParagraphs(input: ContractInput): string[] {
  const legalDuration = legalDurationMonthsLabel(input.durationMonths);
  const program = `«${CONTRACT_SUBTITLE_BRAND_CONSULTING}»`;
  const paragraphs: string[] = [
    `EL CLIENTE conviene cancelar de inmediato, la suma de ${formatContractUsd(
      input.totalAmountUsd,
    )} por la adquisición del programa ${program}. El pago debe realizarse en la ` +
  ...
  paragraphs.push(
    ...
    `5.5. Al aceptar los términos de este acuerdo, EL CLIENTE entiende que está ` +
      `renunciando al derecho de reclamar cualquier reembolso de los honorarios ` +
      `pagados por el acceso y el uso del Programa ${program} ofrecido por LA ` +
      "EMPRESA por CUALQUIER RAZÓN, o reclamar una disputa/solicitar una " +
      "devolución de fondos.",
    "5.6. No serán aceptadas por LA EMPRESA solicitudes de reembolso por parte de " +
      "EL CLIENTE, a excepción de lo previsto en la cláusula 5.8, basadas en las " +
      "siguientes razones: No asistió a las clases grupales dadas por los mentores, " +
      ...
      "cuotas se reanudarían en la fecha acordada anterior sin más cambios en las " +
      "fechas de pago.",
    `5.7. La consultoría ${program} tendrá una duración inicial de ${legalDuration} ` +
      "a partir de la fecha de inicio establecida en este contrato. Durante este " +
      "período, EL CLIENTE recibirá las sesiones y el acompañamiento correspondiente. " +
      "No obstante, el compromiso de LA EMPRESA no se limitará estrictamente a este " +
      `período. En el caso de que EL CLIENTE no haya alcanzado los resultados previstos ` +
...
// Cuerpo legal del contrato BRAND CONSULTING «Unlocked Academy Nivel 6 Brand
// Consulting». Reproduce el texto del PDF oficial de Brand Consulting e
// interpola las variables ya existentes (duración, montos, calendario de
// pagos). NO reutiliza las cláusulas del contrato empresarial: la descripción
// del programa (Tercera), los servicios (Segunda) y las obligaciones (Sexta)
// son específicos del programa de consultoría de marca (D2C).
function buildBrandConsultingSections(
  input: ContractInput,
  duration: string,
): ContractSection[] {
  const program = `«${CONTRACT_SUBTITLE_BRAND_CONSULTING}»`;
  return [
    {
      ...
      paragraphs: [
        `1.1. El objeto del presente contrato consta en la prestación de servicios ` +
          `del Programa de Consultoría ${program} por parte de LA EMPRESA, con el ` +
          "objetivo de ayudarle a EL CLIENTE a crear y crecer su negocio, con todos " +
          "los servicios necesarios para el correcto desempeño del mismo, a cambio de " +
          "la contraprestación por servicios descrita en este mismo acuerdo y que " +
          "ambas partes asumen en estas cláusulas.",
      ],
    },
    {
      id: "servicios",
      heading: "Segunda. Servicios que presta LA EMPRESA",
      paragraphs: [
        `2.1. El programa de consultoría ${program} ofrece los diferentes módulos del ` +
          "programa, con todo el material necesario, tales como vídeos explicativos, " +
          "PDFs, documentación anexa, entre otros materiales de consulta y referencia.",
        "2.2. Clases grupales.",
        `2.3. Acompañamiento durante ${duration} con posibilidad de extensión de tiempo.`,
        "2.4. Hasta cuarenta y ocho (48) sesiones estratégicas personalizadas durante " +
    ...
    {
      id: "programa-brand-consulting",
      heading: "Tercera. DESCRIPCIÓN DEL PROGRAMA DE TRANSFORMACIÓN EMPRESARIAL",
      paragraphs: [
        "3.1. OBJETIVO DEL PROGRAMA",
        "El programa Nivel 6 – Brand Consulting tiene como finalidad acompañar al " +
          "CLIENTE en el desarrollo, estructuración y consolidación de una marca propia " +
          "(D2C) mediante una consultoría estratégica personalizada.",
        "Durante el proceso se trabajará en la construcción de una marca sostenible, " +
          "diferenciada y escalable, incluyendo aspectos relacionados con:",
        `${CONTRACT_BULLET_PREFIX}Estrategia de marca y posicionamiento.`,
        `${CONTRACT_BULLET_PREFIX}Investigación de mercado y definición del buyer persona.`,
        `${CONTRACT_BULLET_PREFIX}Desarrollo de propuesta de valor.`,
        `${CONTRACT_BULLET_PREFIX}Diseño de oferta comercial.`,
        `${CONTRACT_BULLET_PREFIX}Producto y línea de productos.`,
        `${CONTRACT_BULLET_PREFIX}Pricing y unit economics.`,
        `${CONTRACT_BULLET_PREFIX}Packaging y etiquetado.`,
        `${CONTRACT_BULLET_PREFIX}Selección de proveedores.`,
        `${CONTRACT_BULLET_PREFIX}Desarrollo y optimización de tienda Shopify.`,
        `${CONTRACT_BULLET_PREFIX}Estrategia de marketing digital.`,
        `${CONTRACT_BULLET_PREFIX}Email Marketing.`,
        `${CONTRACT_BULLET_PREFIX}Construcción de comunidad.`,
        `${CONTRACT_BULLET_PREFIX}Implementación de indicadores (KPIs).`,
        `${CONTRACT_BULLET_PREFIX}Diseño del plan estratégico de crecimiento.`,
        "3.2. EQUIPO CONSULTOR",
        "EL CLIENTE contará con acceso directo al equipo de mentores de Unlocked " +
          "Academy, liderado por José David Naicipa y Juan Sebastián Naicipa, quienes " +
          "aportan experiencia especializada en el desarrollo, estructuración y " +
        ...
        "3.3. ALCANCE Y DURACIÓN",
        "El programa incluye:",
        `${CONTRACT_BULLET_PREFIX}Consultoría estratégica personalizada durante ${duration}.`,
        `${CONTRACT_BULLET_PREFIX}Hasta cuarenta y ocho (48) sesiones 1:1 programadas ` +
          "durante el año.",
        `${CONTRACT_BULLET_PREFIX}Biblioteca de contenido pregrabado.`,
        `${CONTRACT_BULLET_PREFIX}Clases grupales en vivo y acceso a sus grabaciones.`,
        `${CONTRACT_BULLET_PREFIX}Plantillas, formatos y entregables correspondientes a ` +
          "cada etapa del programa.",
        `${CONTRACT_BULLET_PREFIX}Revisión periódica de indicadores del negocio.`,
        `${CONTRACT_BULLET_PREFIX}Acompañamiento estratégico mediante los canales ` +
          "definidos por LA EMPRESA.",
        `${CONTRACT_BULLET_PREFIX}Acceso a la comunidad privada de Unlocked Academy ` +
          "mientras permanezca activo en el programa.",
        "BENEFICIOS PRINCIPALES. LA EMPRESA se compromete a proporcionar:",
        `${CONTRACT_BULLET_PREFIX}Estrategia de marca propia y diferenciación en el mercado.`,
        `${CONTRACT_BULLET_PREFIX}Sistemas y procesos para escalar operaciones.`,
        `${CONTRACT_BULLET_PREFIX}Estructura organizacional y plan de contratación.`,
        ...
        "3.4. ELEMENTOS ADICIONALES INCLUIDOS. Como parte integral del programa, EL " +
          "CLIENTE recibirá:",
        `${CONTRACT_BULLET_PREFIX}Definición de buyer persona.`,
        `${CONTRACT_BULLET_PREFIX}Desarrollo de propuesta de valor.`,
        `${CONTRACT_BULLET_PREFIX}Construcción de identidad de marca.`,
        `${CONTRACT_BULLET_PREFIX}Diseño de Brand Book.`,
        `${CONTRACT_BULLET_PREFIX}Definición de producto estrella.`,
        `${CONTRACT_BULLET_PREFIX}Desarrollo de línea de productos.`,
        `${CONTRACT_BULLET_PREFIX}Estrategia de pricing.`,
        `${CONTRACT_BULLET_PREFIX}Definición de packaging.`,
        `${CONTRACT_BULLET_PREFIX}Selección de proveedores y muestras.`,
        `${CONTRACT_BULLET_PREFIX}Construcción y optimización de Shopify.`,
        `${CONTRACT_BULLET_PREFIX}Estrategia inicial de contenido.`,
        `${CONTRACT_BULLET_PREFIX}Email Marketing.`,
        `${CONTRACT_BULLET_PREFIX}Dashboard de KPIs.`,
        `${CONTRACT_BULLET_PREFIX}Plan estratégico de crecimiento.`,
        "3.5. METODOLOGÍA DE TRABAJO. El programa se desarrollará siguiendo las " +
          "siguientes fases:",
        `${CONTRACT_BULLET_PREFIX}Meses del 1 al 3: Fundamentos, investigación y ` +
          "posicionamiento.",
        `${CONTRACT_BULLET_PREFIX}Meses del 4 al 6: Identidad, producto, pricing y ` +
          "proveedores.",
        `${CONTRACT_BULLET_PREFIX}Meses del 7 al 9: Shopify, estrategia comercial y ` +
          "marketing.",
        `${CONTRACT_BULLET_PREFIX}Meses del 10 al 12: Lanzamiento, comunidad y métricas.`,
      ],
    },
    {
      id: "vigencia",
    ...
    },
    {
      ...
      paragraphs: [
        "5.1. Se establece la siguiente forma de pago:",
        ...buildBrandConsultingPaymentParagraphs(input),
      ],
    },
    {
      id: "obligaciones",
      ...
      paragraphs: [
        `6.1. LA EMPRESA: Se compromete a prestar los servicios del Programa de ` +
          `Consultoría ${program} con el objetivo de ayudar a crecer el negocio de EL ` +
          "CLIENTE y a ejercer las comunicaciones e indicaciones necesarias para que EL " +
          "CLIENTE quede satisfecho con el servicio recibido. Le proporcionará " +
          "respuestas a través del grupo privado de Telegram y responderá de manera " +
          "oportuna. Ejecutará y supervisará las acciones establecidas en el programa de " +
          "la mano con EL CLIENTE, ayudándole a desbloquear grandes ideas y a dar " +
          "órdenes de marcha claras para ejecutarlas. Brindará soporte y respuesta " +
          ...
          "privada y la participación en el grupo de comunidad del programa. Dará acceso " +
          "a la comunidad «Unlocked Academy», a la comunidad VIP y al grupo privado con " +
          "los mentores del Unlocked Academy. LA EMPRESA brindará acompañamiento " +
          "estratégico para la construcción y desarrollo de la marca del CLIENTE " +
          "conforme a la metodología establecida en el programa Nivel 6 Brand " +
          "Consulting, realizando seguimiento periódico al avance de los objetivos " +
        ...
        "6.2. EL CLIENTE: Se compromete a trabajar en la manera pactada y a seguir " +
          ...
          "Entiende que, en caso de dudas, las llevará a discusión en los encuentros de " +
          "mentoría, para garantizar que el mentor pueda brindar una respuesta con el " +
          "más alto nivel de atención y servicio. EL CLIENTE se compromete a asistir a " +
          "las sesiones programadas y ejecutar las actividades definidas entre una " +
          "sesión y otra, entendiendo que el desarrollo de la marca dependerá de la " +
          "implementación efectiva de las estrategias propuestas.",
        "6.3. Ambas partes se comprometen a las obligaciones contraídas en este " +
          "contrato y a resarcir, en caso de incumplimiento de cualquier cláusula, los " +
          "gastos ocasionados, las penalizaciones y recargos que hayan podido nacer " +
          "fruto de la infracción de alguna de las cláusulas del acuerdo.",
    ...
    },
    {
      ...
      heading: "Novena. Protección de datos personales",
      paragraphs: [
        "Los datos recabados en el proceso de contratación del servicio del Programa de " +
          "Consultoría «Unlocked Academy» y aquellos que sean necesarios para el uso de " +
          "los medios y contenidos, serán tratados por LA EMPRESA con el fin de " +
          "gestionar de la mejor forma el servicio contratado.",
        "9.1. LA EMPRESA podrá enviar al cliente a través del correo electrónico " +
          "facilitado por el mismo, información comercial propia o de terceros " +
          "relacionados con los servicios de LA EMPRESA pudiendo EL CLIENTE negarse al " +
          "mismo en cualquier momento solicitando su desistimiento a través de un correo " +
          "electrónico o a través del procedimiento de baja en las comunicaciones " +
          "comerciales que se insertan en cada correo electrónico que envía LA EMPRESA. " +
          "Además, el cliente podrá contactarse a través de WhatsApp o mensaje de texto.",
        "9.2. La base legal para el tratamiento de los datos del cliente es tanto la " +
          "ejecución de las presentes Condiciones contractuales, así como la " +
          "satisfacción del interés legítimo del responsable en fidelizar al cliente. " +
          "Sus datos serán conservados mientras permanezca vigente la relación " +
          "contractual y durante los plazos de prescripción de responsabilidades legales.",
        "9.3. En caso de que el cliente se incorpore a los grupos de Facebook (o " +
          "cualquier otra red social o similar que se utilice en el servicio del " +
          "Programa de Consultoría «Unlocked Academy») autoriza a que sus datos " +
          "personales sean utilizados en estas plataformas para la gestión de las " +
          "páginas o perfiles del Programa de Consultoría «Unlocked Academy» y de las " +
          ...
          "miembros o seguidores que se han unido al grupo. En todo caso, es " +
          "responsabilidad del cliente el uso que haga de las plataformas.",
        "9.4. LA EMPRESA no utilizará los datos personales de EL CLIENTE para " +
          "finalidades diferentes a las señaladas en las cláusulas anteriores.",
        "9.5. EL CLIENTE garantiza que los datos personales facilitados a LA EMPRESA " +
          "son veraces y están actualizados, y se hace responsable de comunicar " +
          "cualquier modificación de los mismos, siendo EL CLIENTE el único responsable " +
          "de la inexactitud o falsedad de los datos facilitados y de los perjuicios que " +
          "pueda causar por ello a LA EMPRESA o a terceros con motivo de la utilización " +
          ...
          "que los datos recabados son adecuados, pertinentes y no excesivos en relación " +
          "con el ámbito, las finalidades y los servicios determinados.",
        "9.6. EL CLIENTE acepta que sus datos podrán ser cedidos al método de pago que " +
          "use para la contratación del servicio del Programa de Consultoría «Unlocked " +
          "Academy», sea Stripe, PayPal, entre otros wallets de plataformas.",
        "9.7. La cuenta asignada a EL CLIENTE es de uso personal y confidencial. EL " +
          "CLIENTE declara que no permitirá que otras personas utilicen la información " +
          "de Registro y/o la Cuenta y acepta que es el único responsable de mantener la " +
          "confidencialidad y seguridad de los mismos. EL CLIENTE conviene notificar " +
          "inmediatamente a la Compañía cualquier uso no autorizado de su contraseña y/o " +
    ...
    },
    {
      ...
      paragraphs: [
        `14.1. Anexo I: Metodología de la Consultoría. La metodología de la consultoría ` +
          `${program} se detalla en un documento anexo que se entrega en el espacio de ` +
          "onboarding con la líder de servicio, este será leído y firmado en dicho " +
          "espacio.",
        "Para que así conste a los efectos oportunos, se firma por duplicado por ambas " +
          "partes en la fecha fijada, de tal forma que se confiere validez al contrato y " +
          "a todas sus cláusulas previamente expuestas.",
...
export function buildContractView(input: ContractInput): ContractView {
  ...
  const isBrandConsulting = templateKind === "BRAND_CONSULTING";
  ...
  // Cuerpo base según la plantilla: Brand Consulting (cláusulas dedicadas del
  // programa de consultoría de marca), empresarial o tradicional (por defecto).
  const baseSections = isBrandConsulting
    ? buildBrandConsultingSections(input, duration)
    : isBusiness
  ...
  return {
    ...
    subtitle: isBrandConsulting
      ? CONTRACT_SUBTITLE_BRAND_CONSULTING
      : isBusiness
        ? CONTRACT_SUBTITLE_BUSINESS
        : CONTRACT_SUBTITLE,
    parties,
    exponen,
    sections,
